"""mobile_car_wash_23107 URL Configuration
...
admin.site.site_header = "mobile car wash"
admin.site.site_title = "mobile car wash Admin Portal"
admin.site.index_title = "mobile car wash Admin"

# swagger
api_info = openapi.Info(
    title="mobile car wash API",
    default_version="v1",
    description="API documentation for mobile car wash App",
)
